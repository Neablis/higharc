...
let User = (_dec = (0, _typeGraphql.ObjectType)(), _dec2 = (0, _typeorm.Entity)(), _dec3 = (0, _typeGraphql.Field)(() => _typeGraphql.ID), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeGraphql.Field)({
...
}), _dec18 = Reflect.metadata("design:type", String), _dec19 = (0, _typeorm.OneToMany)(() => _Smoothie.default, smoothie => smoothie.user), _dec20 = Reflect.metadata("design:type", Array), _dec21 = (0, _typeGraphql.Field)(), _dec22 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp'
}), _dec23 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec24 = (0, _typeGraphql.Field)(), _dec25 = (0, _typeorm.UpdateDateColumn)({
  type: 'timestamp'
}), _dec26 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec27 = (0, _typeGraphql.Field)(), _dec28 = (0, _typeorm.Column)({
  default: false
}), _dec29 = Reflect.metadata("design:type", Boolean), _dec30 = (0, _typeorm.BeforeInsert)(), _dec31 = Reflect.metadata("design:type", Function), _dec32 = Reflect.metadata("design:paramtypes", []), _dec33 = (0, _typeorm.BeforeInsert)(), _dec34 = Reflect.metadata("design:type", Function), _dec35 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = (_class2 = (_temp = class User extends _typeorm.BaseEntity {
  constructor(...args) {
    super(...args);
  ...
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "smoothies", [_dec19, _dec20], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "createdAt", [_dec21, _dec22, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "updatedAt", [_dec24, _dec25, _dec26], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "isAdmin", [_dec27, _dec28, _dec29], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "addId", [_dec30, _dec31, _dec32], Object.getOwnPropertyDescriptor(_class2.prototype, "addId"), _class2.prototype), (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "hashPassword", [_dec33, _dec34, _dec35], Object.getOwnPropertyDescriptor(_class2.prototype, "hashPassword"), _class2.prototype)), _class2)) || _class) || _class);
