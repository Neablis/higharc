...
let User = (_dec = (0, _typeGraphql.ObjectType)(), _dec2 = (0, _typeorm.Entity)(), _dec3 = (0, _typeGraphql.Field)(() => _typeGraphql.ID, {
...
}), _dec19 = Reflect.metadata("design:type", String), _dec20 = (0, _typeorm.OneToMany)(() => _Smoothie.default, smoothie => smoothie.user), _dec21 = Reflect.metadata("design:type", Array), _dec22 = (0, _typeGraphql.Field)({
  description: 'Users role (only admin exists)'
}), _dec23 = (0, _typeorm.Column)({
  default: false
}), _dec24 = Reflect.metadata("design:type", Boolean), _dec25 = (0, _typeGraphql.Field)({
  description: 'Date Created'
}), _dec26 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp'
}), _dec27 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec28 = (0, _typeGraphql.Field)({
  description: 'Date Last Updated'
}), _dec29 = (0, _typeorm.UpdateDateColumn)({
  type: 'timestamp'
}), _dec30 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec31 = (0, _typeorm.BeforeInsert)(), _dec32 = Reflect.metadata("design:type", Function), _dec33 = Reflect.metadata("design:paramtypes", []), _dec34 = (0, _typeorm.BeforeInsert)(), _dec35 = Reflect.metadata("design:type", Function), _dec36 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = (_class2 = (_temp = class User extends _typeorm.BaseEntity {
  constructor(...args) {
    super(...args);
  ...
  writable: true,
  initializer: null
}), _descriptor7 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "isAdmin", [_dec22, _dec23, _dec24], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "createdAt", [_dec25, _dec26, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = (0, _applyDecoratedDescriptor2.default)(_class2.prototype, "updatedAt", [_dec28, _dec29, _dec30], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
