...
let Ingredient = (_dec = (0, _typeGraphql.ObjectType)(), _dec2 = (0, _typeorm.Entity)(), _dec3 = (0, _typeGraphql.Field)(() => _typeGraphql.ID), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)({
  ...
  nullable: false
}), _dec20 = (0, _classValidator.IsEnum)(IngredientUnit), _dec21 = Reflect.metadata("design:type", typeof IngredientUnit === "undefined" ? Object : IngredientUnit), _dec22 = (0, _typeGraphql.Field)(), _dec23 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp'
