...
exports.authChecker = exports.ErrorInterceptor = exports.logging = exports.authMiddleware = void 0;
...
const authMiddleware = async (req, res, next) => {
  try {
    ...
    req['userId'] = parsedToken === null || parsedToken === void 0 ? void 0 : parsedToken.userId;
  } catch (err) {
    console.error(err);
    err;
  }
