...
let UserResolver = (_dec = (0, _typeGraphql.Resolver)(_User.default), _dec2 = (0, _typeGraphql.Authorized)(), _dec3 = (0, _typeGraphql.Query)(() => _User.default, {
...
}, _dec9 = Reflect.metadata("design:type", Function), _dec10 = Reflect.metadata("design:paramtypes", [typeof _User.default === "undefined" ? Object : _User.default]), _dec11 = (0, _typeGraphql.Mutation)(() => _User.default, {
  ...
  description: "Get a auth token if user/password is correct"
