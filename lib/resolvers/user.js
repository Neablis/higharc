...
let UserResolver = (_dec = (0, _typeGraphql.Resolver)(_User.default), _dec2 = (0, _typeGraphql.Authorized)(), _dec3 = (0, _typeGraphql.Query)(() => _User.default, {
  ...
  return (0, _typeGraphql.Arg)('data', {
    description: "Data for the user you are trying to create"
  })(target, key, 0);
  ...
  return (0, _typeGraphql.Arg)('data', {
    description: "Email and password of the user you are logging in as"
  })(target, key, 0);
  ...
  async login(data) {
    ...
    const loggedIn = await (0, _utils.isPassword)(data.password, existingUser);
