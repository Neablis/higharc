...
let IngredientResolver = (_dec = (0, _typeGraphql.Resolver)(_Smoothie.default), _dec2 = (0, _typeGraphql.Authorized)(), _dec3 = (0, _typeGraphql.Query)(() => _Ingredient.default, {
  ...
  return (0, _typeGraphql.Arg)("id", {
    nullable: false,
    description: "ID of the ingredient you want to get"
  })(target, key, 0);
  ...
  return (0, _typeGraphql.Arg)("id", {
    nullable: false,
    description: "ID of the ingredient you want to update"
  })(target, key, 0);
}, _dec11 = function (target, key) {
  return (0, _typeGraphql.Arg)("updates", {
    nullable: false,
    description: "Updates to the ingredient"
  })(target, key, 1);
  ...
  return (0, _typeGraphql.Arg)("id", {
    nullable: false,
    description: "ID of the ingredient you want to delete"
  })(target, key, 0);
